...
if [ "$1" == "left" ]; then
	HOST=`hostname`
	R="#[fg=colour234,bg=colour148] $HOST #[default]#[fg=colour148,bg=colour33]"
	...
	DATE=$(date "+%m-%d %H:%M")
	R="#[fg=colour237,bg=colour141]#[default]#[fg=colour167,bg=colour237] $BATTERY $TEMP #[default]#[fg=colour37,bg=colour237]"
