...
alias sacct='sacct -a -o User,JobID,Jobname,partition,state,MaxRss,MaxVMSize,avediskread,nnodes,ncpus,nodelist,start,end,elapsed'
alias squeue'squeue -a'
...
alias mount_vfat='sudo mount -o iocharset=utf8,dmask=022,fmask=133,uid=`id -u`,gid=`id -g`'
